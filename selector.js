...
(function () {
    ...
    // For CDN scripts, we need to get the ID from the script src attribute
    function getScriptId() {
        // Find the script element that contains this code
    ...
    // Language map (moved outside the ID check block)
    const languageMap = {
    ...
    // Log the ID match status
    if (trimmedScriptIdFromUrl === trimmedRequiredId) {
        console.log("Script ID matches. Proceeding with translation functionality.");
    } else {
        console.log("Script ID does not match. Translation functionality disabled.");
    }
})();
